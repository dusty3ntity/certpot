...
/**
 * Icon name: autorenew-black-24dp
 */
const RenewalIcon: React.FC<IComponentProps> = ({ id, className, ...props }) => {
	return (
		<svg id={id} className={combineClassNames("icon renewal-icon", className)} viewBox="0 0 24 24" {...props}>
